<h2><b>Due to constant web changes on the <a href="https://www.mass.gov/info-details/covid-19-response-reporting">mass.gov COVID19 tracking site</a>, the main.py is now outdated!</b></h2>
